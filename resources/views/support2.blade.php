...
<div class="bg-primary">
    <div class="bg-pattern bg-black-op-25" style="background-image: url('images/bg-pattern.png');">
        <div class="content content-top text-center">
            <div class="py-50">
                <h1 class="font-w700 text-white mb-10">Do you have any questions or any issues?</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-8 col-xl-6">
                    ...
                    <form method="POST" id="contact" class="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control form-control-lg round" id="name" name="name" placeholder="Full name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12" for="email">Email</label>
                            <div class="col-12">
                                <input type="email" class="form-control form-control-lg round" id="email" name="email" placeholder="Enter your email">
                            </div>
                        </div>
                        <div class="form-group row">
