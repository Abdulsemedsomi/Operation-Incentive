     ...
     <div  class="container neopad " >
         <div class="card text-center" >
             <div class="card-body text-left">
                    <form action = "{{ route('teditweeklyplan', $plan->id)}}" id="submiteditweeklyplan"  method="post">
                        @csrf
                        ...
                        @foreach($objectives as $objs)
                            ...
                            <div class="card-body">
                                ...
                                <button type="submit" class="btn btn-rounded btn-outline-primary " onclick="Codebase.loader('show', 'bg-gd-sea');setTimeout(function () { Codebase.loader('hide'); });">Edit Weekly target</button>
                                <div class="col-md-1"></div>
                                <a type="button" class="btn btn-rounded btn-outline-danger " href="{{ route('tweeklyplan', ['teamid'=>$team->id, 'sessionid'=>$session->id]) }}" onclick="Codebase.loader('show', 'bg-gd-sea');setTimeout(function () { Codebase.loader('hide'); });">Cancel</a>
                                </div>
                            </div>
                    </form>
             </div>
