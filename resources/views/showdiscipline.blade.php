        ...
        <div class="block-content">
            ...
            <table class="table table-bordered table-vcenter">
                <tbody style="font-size: 20px;">
                    ...
                    <td>Name: {{App\User::find($engagement->issued_to)->fname . " ". App\User::find($engagement->issued_to)->lname}}</td>
                    </tr>
                    <tr>
                        <td style="width:450px;">Position: {{App\User::find($engagement->issued_to)->position}}</td>
                    </tr>
                <tr>
                    <td>
                        <p>Discipline on : </p>
                    ...
                    <td>
                        ...
                        {{App\Engagement::find($engagement->engagement_id)->Objective}}
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr style="height: 50px;">
                    ...
                    <td>
                        <p><p>{{$engagement->Improvement}} </p></p>
                    </td>
                </tr>
