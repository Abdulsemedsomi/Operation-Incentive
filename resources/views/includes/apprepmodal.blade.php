            ...
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-alt-success" >
                     ...
                     <button type="button" class="btn btn-alt-secondary" id="repremiandkbutton" onclick="Codebase.loader('show', 'bg-gd-sea');setTimeout(function () { Codebase.loader('hide'); });" hidden></button>
        ...
        <div class="modal-content">
            ...
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="container">
                    <div class="block-content">
                        <input type="hidden" name="Perspective" value=1>
                        <input type="hidden" name="plan_id" id="engrepplan" value=0>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-alt-secondary" id="repremiandebutton" onclick="Codebase.loader('show', 'bg-gd-sea');setTimeout(function () { Codebase.loader('hide'); });" hidden></button>
                    <button type="button" class="btn btn-alt-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
            </form>
            ...
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-alt-success" >
                     ...
                     <button type="button" class="btn btn-alt-secondary" id="appreciationkbutton" onclick="Codebase.loader('show', 'bg-gd-sea');setTimeout(function () { Codebase.loader('hide'); });" hidden></button>
                    <button type="button" class="btn btn-alt-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
            </form>
        ...
        <div class="modal-content">
            ...
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="container">
                    <div class="block-content">
                        <input type="hidden" name="Perspective" value=0>
                        <input type="hidden" name="plan_id" id="engappplan">
                         <input type="hidden" name="apptype" value=1>
                        <div class="form-group row">
                            <label class="col-4" for="example-select">Employee name</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-alt-secondary" id="appreciationebutton" onclick="Codebase.loader('show', 'bg-gd-sea');setTimeout(function () { Codebase.loader('hide'); });" hidden></button>
                    <button type="button" class="btn btn-alt-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
            </form>
...
$(document).ready(function () {
 $("#reprimande").submit(function(e) { 
    ...
    document.getElementById("repremiandebutton").click();
   document.getElementById('reprimande').submit();
}
 });
 
 $("#appreciatione").submit(function(e) { 
       e.preventDefault();
       if( $("input").filter(function () {
    return $.trim($(this).val()).length == 0
}).length == 0){
    ...
    document.getElementById("appreciationebutton").click();
   document.getElementById('appreciatione').submit();
}
 });
  $("#appreciationk").submit(function(e) { 
       e.preventDefault();
       if( $("input").filter(function () {
    return $.trim($(this).val()).length == 0
}).length == 0){
    ...
    document.getElementById("appreciationkbutton").click();
   document.getElementById('appreciationk').submit();
}
 });
   $("#reprimandk").submit(function(e) { 
       e.preventDefault();
       if( $("input").filter(function () {
    return $.trim($(this).val()).length == 0
}).length == 0){
    ...
    document.getElementById("repremiandkbutton").click();
   document.getElementById('reprimandk').submit();
}
 });
